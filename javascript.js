...
const firstShift = {
    ...
    "2023-05-24": ["صيدلية فاطمة", "صيدلية عمر", "صيدلية بيت الدواء", "صيدلية أسماء"],
    ...
    "2023-05-30": ["صيدلية التلاوي", "صيدلية رغد دحنون", "صيدلية الرازي", "صيدلية المركزية"],
...
const thirdShift = {
    ...
    "2023-05-21": ["صيدلية العيسى", "صيدلية الولاء", "صيدلية نور الحياة", "صيدلية رغد دحنون", "صيدلية الاعتماد", "صيدلية اسلام سفلو", "صيدلية عدنان هشوم", "صيدلية الخلف", "صيدلية محمد", "صيدلية الوطني", "صيدلية عبد الناصر", "صيدلية جود مرشان", "صيدلية مريم", "صيدلية برهوم", "صيدلية علاء طكو", "صيدلية النبهان", "صيدلية أحمد جنكي", "صيدلية مروة ياسين", "صيدلية المجمع الطبي", "صيدلية الرازي", "صيدلية عامر فاخورجي", "صيدليةالزير", "صيدلية الجلاء", "صيدلية طارق ترك", "صيدلية الوجيه", "صيدلية هاجر السيد علي", "صيدلية مريم النعسان", "صيدلية الايمان", "صيدلية الشفاء"],
    "2023-05-22": ["صيدلية خلود شحود", "صيدلية اسبرين", "صيدلية سوسن السعيد", "صيدلية إيبلا", "صيدلية عمر", "صيدلية اليمان", "صيدلية عبدالله", "صيدلية روضة كنش", "صيدلية السعد", "صيدلية نهى علوش", "صيدلية بيت الدواء", "صيدلية القصاص", "صيدلية يزن يونس ذهب", "صيدلية آية الرحمن", "صيدلية القصور", "صيدلية لمى", "صيدلية نور حمادة", "صيدلية أنس حبوش", "صيدلية يحيى نعمة", "صيدلية التلاوي", "صيدلية فراس غجر", "صيدلية علاء الدين", "صيدلية عز الدين", "صيدلية فحيل", "صيدلية ولاء سيد يوسف", "صيدلية فاطمة راجي", "صيدلية قتيبة", "صيدلية رحابي", "صيدلية الجامعي"],
    "2023-05-23": ["صيدلية نذير العتقي", "صيدلية رؤى قريطبي", "صيدلية النورس", "صيدلية النحلة", "صيدلية الصفا", "صيدلية العالمية", "صيدلية الأسرار", "صيدلية هنادي قوصرة", "صيدلية الجدعان", "صيدلية العالمية", "صيدلية المركزية", "صيدلية البلسم", "صيدلية سارة شحاذة", "صيدلية عبدو صناع", "صيدلية الخنساء", "صيدلية اسلام معدل", "صيدلية علي الشيخ أحمد", "صيدلية العاصي", "صيدلية الأمين", "صيدلية باسل غفير", "صيدلية محمد حاج أسعد", "صيدلية آلاء النمر", "صيدلية نور سليمان عوض", "صيدلية براء", "صيدلية إيناس الحسين", "صيدلية ضياء كشايا", "صيدلية مصطفى حبوش", "صيدلية المارتيني(راما)"],
    ...
    "2023-05-26": ["صيدلية نذير العتقي", "صيدلية رؤى قريطبي", "صيدلية النورس", "صيدلية النحلة", "صيدلية الصفا", "صيدلية العالمية", "صيدلية الأسرار", "صيدلية هنادي قوصرة", "صيدلية الجدعان", "صيدلية العالمية", "صيدلية المركزية", "صيدلية البلسم", "صيدلية سارة شحاذة", "صيدلية عبدو صناع", "صيدلية الخنساء", "صيدلية اسلام معدل", "صيدلية علي الشيخ أحمد", "صيدلية العاصي", "صيدلية الأمين", "صيدلية باسل غفير", "صيدلية محمد حاج أسعد", "صيدلية آلاء النمر", "صيدلية نور سليمان عوض", "صيدلية براء", "صيدلية إيناس الحسين", "صيدلية ضياء كشايا", "صيدلية مصطفى حبوش", "صيدلية المارتيني(راما)"],
    "2023-05-27": ["صيدلية خلود شحود", "صيدلية اسبرين", "صيدلية سوسن السعيد", "صيدلية إيبلا", "صيدلية عمر", "صيدلية اليمان", "صيدلية عبدالله", "صيدلية روضة كنش", "صيدلية السعد", "صيدلية نهى علوش", "صيدلية بيت الدواء", "صيدلية القصاص", "صيدلية يزن يونس ذهب", "صيدلية آية الرحمن", "صيدلية القصور", "صيدلية لمى", "صيدلية نور حمادة", "صيدلية أنس حبوش", "صيدلية يحيى نعمة", "صيدلية التلاوي", "صيدلية فراس غجر", "صيدلية علاء الدين", "صيدلية عز الدين", "صيدلية فحيل", "صيدلية ولاء سيد يوسف", "صيدلية فاطمة راجي", "صيدلية قتيبة", "صيدلية رحابي", "صيدلية الجامعي"],
    "2023-05-28": ["صيدلية نذير العتقي", "صيدلية رؤى قريطبي", "صيدلية النورس", "صيدلية النحلة", "صيدلية الصفا", "صيدلية العالمية", "صيدلية الأسرار", "صيدلية هنادي قوصرة", "صيدلية الجدعان", "صيدلية العالمية", "صيدلية المركزية", "صيدلية البلسم", "صيدلية سارة شحاذة", "صيدلية عبدو صناع", "صيدلية الخنساء", "صيدلية اسلام معدل", "صيدلية علي الشيخ أحمد", "صيدلية العاصي", "صيدلية الأمين", "صيدلية باسل غفير", "صيدلية محمد حاج أسعد", "صيدلية آلاء النمر", "صيدلية نور سليمان عوض", "صيدلية براء", "صيدلية إيناس الحسين", "صيدلية ضياء كشايا", "صيدلية مصطفى حبوش", "صيدلية المارتيني(راما)"],
...
const pharmacyLocation = {
    ...
    "صدلية روضة كنش": "https://maps.app.goo.gl/5KEt8j3TMErFRwXi8",
