...
const thirdShift = {
    ...
    "2023-05-21": ["صيدلية العيسى", "صيدلية الولاء", "صيدلية نور الحياة", "صيدلية رغد دحنون", "صيدلية الاعتماد", "صيدلية اسلام سفلو", "صيدلية عدنان هشوم", "صيدلية الخلف", "صيدلية محمد", "صيدلية الوطني", "صيدلية عبد الناصر", "صيدلية جود مرشان", "صيدلية مريم", "صيدلية برهوم", "صيدلية علاء طكو", "صيدلية النبهان", "صيدلية أحمد جنكي", "صيدلية مروة ياسين", "صيدلية المجمع الطبي", "صيدلية الرازي", "صيدلية عامر فاخورجي", "صيدلية الزير", "صيدلية الجلاء", "صيدلية طارق ترك", "صيدلية الوجيه", "صيدلية هاجر السيد علي", "صيدلية مريم النعسان", "صيدلية الايمان", "صيدلية الشفاء"],
